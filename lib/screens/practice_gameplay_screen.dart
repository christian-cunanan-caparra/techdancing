...
class _PracticeGameplayScreenState extends State<PracticeGameplayScreen>
  ...
  Future<void> _exitGame() async {
    ...
    _isExiting = true;
    debugPrint("🔄 Exiting practice safely...");
      ...
      switch (widget.danceId) {
        ...
        case 3: // AVA MAX - SALT (PRECISE MUSIC TIMING)
          _danceSteps = [
            ...
            {
              'name': 'Salt Finale',
              'description': "Confident ending pose - own the moment",
              'duration': 6,
              'originalDuration': 6,
              'scoringLogic': _scoreSaltEnding,
              'poseType': 'salt_ending',
            },
          ];
          break;
                    ...
                    children: [
                      FutureBuilder<String>(
                        ...
                        builder: (context, snapshot) {
                          String danceName = "Practice Dance";
                          if (snapshot.hasData) {
